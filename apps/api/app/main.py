...
from app.routers import health, schema, fraud, data, demo, stream, auth, workflow, chat, branches, auth_webauthn, admin
...
app.include_router(auth_webauthn.router, prefix=f"{settings.API_V1_STR}/auth")
