...
class UserCreate(BaseModel):
    ...
    role: Optional[StrictStr] = 'Investigator'
    __properties: ClassVar[List[str]] = ["username", "password", "full_name", "branch_id", "role"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "role": obj.get("role") if obj.get("role") is not None else 'Investigator'
        })
        return _obj
